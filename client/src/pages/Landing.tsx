          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
              ...
              >
                ...
                >
                  <span className="inline-flex items-center rounded-full bg-indigo-600 px-2.5 py-1 text-xs font-medium text-white mr-2">
                    New
                  </span>
                ...
                >
                  TaskNest helps teams break down complex projects into
                  manageable pieces with unlimited subtask nesting and powerful
                  collaboration tools.
                </motion.p>
        ...
        <section className="py-24 bg-white dark:bg-gray-900" ref={featuresRef}>
          <div className="container px-4 md:px-6">
            <motion.div
              ...
              animate={
                isFeatureInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
              }
            ...
            >
              <div className="space-y-2">
                ...
                >
                  TaskNest's powerful features help teams stay organized and
                  boost productivity
                </motion.p>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <p className="mt-3 text-gray-600 dark:text-gray-400 leading-relaxed">
                  Build complex hierarchies with unlimited subtasks to organize
                  your projects with precision and clarity.
                </p>
                <motion.ul
              ...
              >
                ...
                <p className="mt-3 text-gray-600 dark:text-gray-400 leading-relaxed">
                  Create custom tags to categorize and filter tasks across
                  different projects and hierarchies for better organization.
                </p>
                <motion.ul
                  className="mt-6 space-y-2"
                  variants={staggerContainer}
              ...
              >
                ...
                <p className="mt-3 text-gray-600 dark:text-gray-400 leading-relaxed">
                  Work seamlessly with your team, assign tasks, and comment with
                  @mentions for clear communication and accountability.
                </p>
                <motion.ul
                  className="mt-6 space-y-2"
                  variants={staggerContainer}
            ...
            <div className="flex flex-col items-center justify-center text-center mb-12">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 md:text-xl/relaxed">
                  See how TaskNest transforms complex projects into manageable
                  workflows
                </p>
              </motion.div>
            </div>
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Build task hierarchies with unlimited nesting to break down
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Assign tasks, comment with @mentions, and track progress in
                  real-time with your entire team.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Monitor progress with intuitive dashboards and complete tasks
                  efficiently with automatic parent task updates.
                </p>
              </motion.div>
            </motion.div>
            ...
            >
              <div className="space-y-4">
                ...
                <motion.p
                  ...
                  transition={{ duration: 0.7, delay: 0.3 }}
                >
                  Start using TaskNest today - 100% free with all features
                  included
                </motion.p>
              </div>
              ...
              >
                ...
                <span>
                  Free forever • All features included • No credit card required
                </span>
              </motion.div>
            </motion.div>
          </div>
