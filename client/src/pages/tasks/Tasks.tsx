...
const TasksList = () => {
  ...
  const workspaces = useMemo(() => {
    ...
    return Array.isArray(workspacesResponse)
      ? workspacesResponse
      : (workspacesResponse as { data?: any[] })?.data ?? [];
  }, [workspacesResponse]);
  ...
  return (
    <div className="container py-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            ...
            {filters.workspace !== "all"
              ? `in ${getWorkspaceName(filters.workspace)}`
                  ...
                  tasks.map((task) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4">
                        {task.workspaceId ? (
                          <div
                            className="inline-flex items-center px-2 py-1 rounded-md text-xs bg-opacity-20"
                            style={{
                              backgroundColor: `${
                                typeof task.workspaceId === "object"
                                  ? (task.workspaceId as Workspace).color
                                  : "#6366F1"
                              }20`,
                              color:
                                typeof task.workspaceId === "object"
      ...
      <CreateTaskDialog
        ...
        defaultWorkspaceId={
          filters.workspace !== "all" ? filters.workspace : undefined
        }
        onSuccess={() => {
          setFilters({ ...filters });
        }}
